...
pub struct ResetStartRequest {
    ...
    /// email_address: The email address of the Member to start the email reset process for.
    pub email_address: String,
    /// reset_password_redirect_url: The URL that the Member is redirected to from the reset password magic
    /// link. This URL should display your application's reset password page.
    ...
    /// login_redirect_url: The URL that Members are redirected to upon clicking the "Log in without password"
    /// button in password reset emails.
    ///
    ///   After Members are redirected to the login redirect URL, your application should retrieve the `token`
    ...
    /// your default email template. Templates can be added in the
